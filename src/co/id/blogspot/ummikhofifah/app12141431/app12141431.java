...
package co.id.blogspot.ummikhofifah.app12141431;

import java.util.Scanner;

public class app12141431 {
    String nama;
    byte level = 1;
    byte kesempatan = 5;
    short tebak;
    ...
    public void Score() {
        ...
        System.out.println("Ainun\t: 70");
        System.out.println("Habibie\t: 50");
        System.out.println("Ummi\t: 100");
        System.out.println("Syifa\t: 100");
    }
    
    public static void main(String[] args) {
        app12141431 main = new app12141431();
        ...
        {   
            ...
            System.out.println("Selamat datang di Permainan ini " + main.nama);   
